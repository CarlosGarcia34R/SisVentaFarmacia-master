...
BEGIN
    ...
    IF NOT EXISTS (SELECT * FROM ventas WHERE idtransaccion = @IdTransaccion)
    BEGIN
        INSERT INTO ventas(idcliente, totalproducto, montototal, contacto, iddistrito, telefono, direccion, idtransaccion)
    ...
    ELSE
    BEGIN
        SET @Mensaje = 'La transacción ya existe';
    END
END;
